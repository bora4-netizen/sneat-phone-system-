...
<div class="content-wrapper">
    ...
    @endif
      ...
      @endcan
        <div class="row">
            <div class="col-md-12">
              <form id="formLoanUpdate" method="POST" action="{{ route('loans.update', withLang(['loan' => $loan->id])) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card mb-4">
                    <h5 class="card-header">{{__('loan.edit')}}</h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <select id="customer_id" class="select2 form-select @error('customer_id') is-invalid @enderror" name="customer_id">
                                    ...
                                    @foreach ($customers as $customer)
                                        <option value="{{ $customer->id }}" @if(old('customer_id', $loan->customer_id) == $customer->id) selected @endif>{{ $customer->name }}</option>
                                    @endforeach
                                </select>
                                @error('customer_id')
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select id="product_id" class="select2 form-select @error('product_id') is-invalid @enderror" name="product_id">
                                    ...
                                    @foreach ($availableProducts as $product)
                                        <option disabled value="{{ $product->id }}" data-value="{{ $product->selling_price }}" @if(old('product_id', $loan->product_id) == $product->id) selected @endif>{{ $product->product_name }}　[ IMEI: {{ substr($product->product_imei, -5) }} ]</option>
                                    @endforeach
                                    @if($loan->product)
                                      <option value="{{ $loan->product->id }}" data-value="{{ $loan->product->selling_price }}" @if(old('product_id', $loan->product_id) == $loan->product->id) selected @endif>{{ $loan->product->product_name }} [ IMEI: {{ substr($loan->product->product_imei, -5) }} ]</option>
                                    @endif
                                </select>
                                @error('product_id')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    <input class="form-control @error('amount') is-invalid @enderror" type="text" value="{{ old('amount', $loan->amount) }}" id="amount" name="amount"/>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    <input class="form-control @error('interest') is-invalid @enderror" type="text" value="{{ old('interest', $loan->interest) }}" id="interest" name="interest"/>
                                    <span class="input-group-text">%</span>
                                </div>
                                @error('interest')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control @error('duration') is-invalid @enderror" type="text" value="{{ old('duration', $loan->duration) }}" id="duration" name="duration"/>
                                @error('duration')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                              ...
                              <div class="mb-3 col-md-3">
                                ...
                                <div class="input-group input-group-merge">
                                  <input class="form-control" type="text" readonly id="amount_principal" name="amount_principal" value="{{ old('amount_principal', $loan->amount_principal)}}"/>
                                  <span class="input-group-text">$</span>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 col-md-3">
                              ...
                              <div class="input-group input-group-merge">
                                <input class="form-control" type="text" readonly id="amount_interest" name="amount_interest" value="{{ old('amount_interest', $loan->amount_interest)}}"/>
                                <span class="input-group-text">$</span>
                              </div>
                          </div>
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <div class="input-group input-group-merge">
                                  <input class="form-control" type="text" readonly id="monthly_payment" name="monthly_payment" value="{{ old('monthly_payment', $loan->monthly_payment)}}"/>
                                  <span class="input-group-text">$</span>
                                </div>
                            </div>
                            <div class="mb-3 col-md-3">
                              ...
                              <div class="input-group input-group-merge">
                                <input class="form-control" type="text" readonly id="payable_amount" name="payable_amount" value="{{ old('payable_amount', $loan->payable_amount)}}"/>
                                <span class="input-group-text">$</span>
                              </div>
                          </div>
                            ...
                            <div class="mb-3 col-md-6">
                              ...
                              <div class="mb-3 col-md-6">
                                  ...
                                  <select id="status" class="select2 form-select @error('status') is-invalid @enderror" name="status">
                                      @foreach ($statusOptions as $key => $value)
                                          <option value="{{ $key }}" @if(old('status', $loan->status) == $key) selected @endif>{{ $value }}</option>
                                      @endforeach
                                  </select>
                                  @error('status')
                                      <span class="invalid-feedback" role="alert">
                              ...
                              <!-- Row 5: Textarea for Note -->
                              <div class="mb-3 col-md-12">
                                  <label class="form-label" for="note">{{__('loan.note')}}</label>
                                  <textarea id="note" class="form-control" name="note">{{ old('note', $loan->note) }}</textarea>
                              </div>
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <div class="mt-3">
                                    <select id="customer_id_card" class="select2 form-select @error('customer_id_card') is-invalid @enderror" name="customer_id_card">
                                        ...
                                        <option value="1" @if(old('customer_id_card', $loan->document->customer_id_card ?? 0) == 1) selected @endif>{{__('loan.document_original')}}</option>
                                        <option value="2" @if(old('customer_id_card', $loan->document->customer_id_card ?? 0)  == 2 ) selected @endif>{{__('loan.document_copy')}}</option>
                                    </select>
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <div class="mt-3">
                                    <select id="customer_family_book" class="select2 form-select @error('customer_family_book') is-invalid @enderror" name="customer_family_book">
                                        <option value="0" selected>{{__('loan.document_none')}}</option>
                                        <option value="1" @if(old('customer_family_book', $loan->document->customer_family_book ?? 0) == 1) selected @endif>{{__('loan.document_original')}}</option>
                                        <option value="2" @if(old('customer_family_book', $loan->document->customer_family_book ?? 0) == 2) selected @endif>{{__('loan.document_copy')}}</option>
                                    </select>
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <div class="mt-3">
                                    <select id="customer_birth_certificate" class="select2 form-select @error('customer_birth_certificate') is-invalid @enderror" name="customer_birth_certificate">
                                        <option value="0" selected>{{__('loan.document_none')}}</option>
                                        <option value="1" @if(old('customer_birth_certificate', $loan->document->customer_birth_certificate ?? 0) == 1) selected @endif>{{__('loan.document_original')}}</option>
                                        <option value="2" @if(old('customer_birth_certificate', $loan->document->customer_birth_certificate ?? 0) == 2) selected @endif>{{__('loan.document_copy')}}</option>
                                    </select>
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <div class="mt-3">
                                    <input class="form-control" type="text" id="customer_other" name="customer_other" value="{{ old('customer_other', $loan->document->customer_other ?? '')}}"/>
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <div class="mt-3">
                                    <select id="guarantor_id_card" class="select2 form-select @error('guarantor_id_card') is-invalid @enderror" name="guarantor_id_card">
                                        <option value="0" selected>{{__('loan.document_none')}}</option>
                                        <option value="1" @if(old('guarantor_id_card', $loan->document->guarantor_id_card ?? 0) == 1) selected @endif>{{__('loan.document_original')}}</option>
                                        <option value="2" @if(old('guarantor_id_card', $loan->document->guarantor_id_card ?? 0) == 2) selected @endif>{{__('loan.document_copy')}}</option>
                                    </select>
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <div class="mt-3">
                                    <select id="guarantor_family_book" class="select2 form-select @error('guarantor_family_book') is-invalid @enderror" name="guarantor_family_book">
                                        <option value="0" selected>{{__('loan.document_none')}}</option>
                                        <option value="1" @if(old('guarantor_family_book', $loan->document->guarantor_family_book ?? 0) == 1) selected @endif>{{__('loan.document_original')}}</option>
                                        <option value="2" @if(old('guarantor_family_book', $loan->document->guarantor_family_book ?? 0) == 2) selected @endif>{{__('loan.document_copy')}}</option>
                                    </select>
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <div class="mt-3">
                                    <select id="guarantor_birth_certificate" class="select2 form-select @error('guarantor_birth_certificate') is-invalid @enderror" name="guarantor_birth_certificate">
                                        <option value="0" selected>{{__('loan.document_none')}}</option>
                                        <option value="1" @if(old('guarantor_birth_certificate', $loan->document->guarantor_birth_certificate ?? 0) == 1) selected @endif>{{__('loan.document_original')}}</option>
                                        <option value="2" @if(old('guarantor_birth_certificate', $loan->document->guarantor_birth_certificate ?? 0) == 2) selected @endif>{{__('loan.document_copy')}}</option>
                                    </select>
                            ...
                            <div class="mb-3 col-md-3">
                                <small class="text-light fw-medium">{{__('loan.document_other')}}</small>
                                <div class="mt-3">
                                    <input class="form-control" type="text" id="guarantor_other" name="guarantor_other" value="{{ old('guarantor_other', $loan->document->guarantor_other ?? '')}}"/>
...
<script>
  $(document).ready(function() {
        ...
        function calculateLoanValues() {
            ...
            var payableAmount = payPerMonth.toFixed(2) * numberOfPayments.toFixed(2);

            $amountPrincipaltMonth.val(monthlyPrincipal.toFixed(2));
            $amountInterestMonth.val(monthlyInterest.toFixed(2));
