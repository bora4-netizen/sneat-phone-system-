    ...
    @method('PUT')
                    <div class="card mb-4">
                        ...
                        <div class="mb-3 form-password-toggle col-6">
                            ...
                            {{-- ✅ error is now OUTSIDE input-group --}}
                            ...
                            <div class="mb-3 form-password-toggle col-6">
                                ...
                                <div class="input-group input-group-merge">
                                   <input id="new-password"type="password" class="form-control @error('new_password') is-invalid @enderror"name="new_password" placeholder="••••••••"required   autocomplete="new-password">
                                    @error('new_password')
