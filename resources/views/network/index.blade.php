                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="{{ url((request()->lang ?? 'en') . '/networks/' . $network->id) }}" class="btn btn-icon btn-outline-secondary edit-model-type" data-bs-toggle="modal" data-bs-target="#editModelType" data-id="{{ $network->id }}" data-value="{{ $network->name }}">
                                    <span class="tf-icons bx bx-edit-alt"></span>
                                </a>
                                <form action="{{ route('network.destroy', [request()->lang ?? 'en', $network->id]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
